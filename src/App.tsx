...
const logradourosIniciais: Logradouro[] = [
  {
    id: 1,
    bairro: 'Quatro Bocas',
    nome: 'Dionísio Bentes',
    tipo: 'Avenida',
    quantidadeImoveis: 45,
    observacoes: 'Principal via comercial.',
  },
  {
    id: 2,
    bairro: 'Taboleiro',
    nome: '15 de Novembro',
    tipo: 'Rua',
    quantidadeImoveis: 30,
    observacoes: 'Área residencial densa.',
  },
  {
    id: 3,
    bairro: 'Vila de Fora',
    ...
    observacoes: 'Acesso à zona rural.',
  },
]
...
const familiasIniciais: Familia[] = [
  {
    ...
    tipoImovel: 'Casa',
    nome: 'Família Santos',
    responsavel: 'Raimundo Santos',
    telefone: '(91) 98822-1100',
    quantidadeMoradores: 3,
    situacaoMoradia: 'Própria',
    observacoes: 'Casa de alvenaria.',
  ...
  },
  {
    ...
    telefone: '(91) 98833-2211',
    quantidadeMoradores: 4,
    situacaoMoradia: 'Alugada',
    observacoes: 'Ponto de referência: próximo ao mercado.',
  ...
  },
  {
    ...
    telefone: '(91) 98844-3322',
    quantidadeMoradores: 2,
    situacaoMoradia: 'Própria',
    observacoes: 'Bloco A, Apto 201.',
  ...
  },
  {
    ...
    telefone: '(91) 98855-4433',
    quantidadeMoradores: 1,
    situacaoMoradia: 'Própria',
    observacoes: 'Idosa morando sozinha.',
  ...
  },
  {
    ...
    tipoImovel: 'Sítio',
    nome: 'Família Souza',
    responsavel: 'Benedito Souza',
    telefone: '',
    quantidadeMoradores: 5,
    situacaoMoradia: 'Cedida',
    observacoes: 'Sítio Boa Esperança.',
    ultimaVisita: '2026-01-05',
    status: 'atrasada',
  },
]
...
const moradoresIniciais: Morador[] = [
  {
    id: 1,
    familiaId: 1,
    nome: 'Raimundo Nonato Santos',
    cpf: '123.456.789-01',
    cns: '700000000000001',
    nis: '12345678901',
    nascimento: '1965-05-12',
    sexo: 'Masculino',
    telefone: '(91) 98822-1100',
    peso: '75',
    altura: '1.70',
  ...
  },
  {
    ...
    medicamento: '',
    vacinaEmDia: false,
    observacoes: 'Vacina de 1 ano pendente.',
  },
  {
    id: 5,
    familiaId: 3,
    ...
    diabetico: true,
    remedioControlado: true,
    medicamento: 'Gliclazida, Losartana',
    vacinaEmDia: true,
    observacoes: 'Necessita acompanhamento rigoroso.',
  },
  {
    id: 6,
    familiaId: 4,
